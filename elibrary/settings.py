...
SECRET_KEY = 'django-insecure-ce0cx*jy5+yw0gps&rx83og3p$offx#c&5s@^=2c2@08c5pjjg'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'libraryApp/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'elibrary_db',  # Nama database PostgreSQL
        'USER': 'postgres',  # Ganti dengan username PostgreSQL-mu
        'PASSWORD': 'root',  # Ganti dengan password PostgreSQL-mu
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
